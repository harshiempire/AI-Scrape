...
var ToolRegistry = /** @class */ (function () {
    ...
    ToolRegistry.prototype.register = function (tool) {
        if (this.tools.has(tool.name)) {
            throw new Error("Tool already registered: ".concat(tool.name));
        }
    ...
    ToolRegistry.prototype.callTool = function (name, input) {
    ...
    ToolRegistry.prototype.toFunctionSpecs = function () {
        return this.list().map(function (tool) { return tool.getMetadata(); });
    };
    return ToolRegistry;
}());
