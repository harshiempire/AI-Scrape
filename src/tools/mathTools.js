...
var MathTools = /** @class */ (function () {
    ...
    MathTools.createTools = function () {
        var _this = this;
        return [
            new tool_js_1.Tool({
                name: "calculateSum",
                description: "Adds up numbers",
                schema: zod_1.z.object({ numbers: zod_1.z.array(zod_1.z.number()) }),
                func: function (input) { return __awaiter(_this, void 0, void 0, function () {
                    var numbers;
                    return __generator(this, function (_a) {
                        numbers = input.numbers;
                        return [2 /*return*/, { sum: numbers.reduce(function (a, b) { return a + b; }, 0) }];
                    });
                }); }
            }),
            new tool_js_1.Tool({
                ...
                func: function (input) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        numbers = input.numbers;
                        return [2 /*return*/, { product: numbers.reduce(function (a, b) { return a * b; }, 1) }];
                    });
                }); }
            }),
            new tool_js_1.Tool({
                ...
                func: function (input) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        return [2 /*return*/, { average: sum / numbers.length }];
                    });
                }); }
            })
        ];
