export class ContentChunker {
    ...
    createOverlapChunk(chunk, overlapSize) {
    ...
    createChunk(content, metadata, chunkIndex, totalChunks) {
        return {
    ...
    calculateContentQuality(content, metadata) {
        let quality = 0;
    ...
    getContentTypeScore(contentType) {
        const typeScores = {
            'documentation': 0.9,
            'article': 0.8,
            'news': 0.7,
